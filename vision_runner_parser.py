...
from vision import DetectModelConfig, TrainModelConfig
...
class VisionRunnerParser:
    ...
    def parse_from_file(self, file_name_or_path="config.yaml"):
        ...
        (train_config_dict, detect_config_dict) = self._parse_configs(configs)
    ...
    def _parse_configs(self, configs: List[any]) -> Tuple[dict, dict]:
        ...
        return train_config_dict, detect_config_dict
